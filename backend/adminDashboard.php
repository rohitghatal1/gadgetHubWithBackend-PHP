...
if (isset($_SESSION['adminUsername'])) {
    ...
    $adminAvatar = <<<dropdown
            <div class="userDropdown position-relative">
                <div class="avatar bg-danger p-1 rounded-circle" onclick="toggleDropdown(event);" style="width:1.5rem;height:1.5rem;display:flex;justify-content:center;align-items:center;">$firstLetterAvatar</div>
    ...
    <div class="pt-5 pb-2" style="background-color: #161b40;">
            ...
            ?>
                <div class="p-2 bg-info-subtle col-3 rounded">
                    <div class="bg-dark text-light rounded p-3 py-5">
                        <h5 class="text-center"><a href="#laptops" class="text-decoration-none text-light">Laptops</a>
                        </h5>
                ...
                <div class="p-2 bg-info-subtle col-3 rounded">
                    <div class="bg-dark text-light rounded p-3 py-5">
                        <h5 class="text-center"><a href="#mobiles" class="text-decoration-none text-light">Mobiles</a>
                        </h5>
                ...
                <div class="p-2 bg-info-subtle col-3 rounded">
                    <div class="bg-dark text-light rounded p-3 py-5">
                        <h5 class="text-center"><a href="#smartWatches" class="text-decoration-none text-light">Smart
                                Watches</a></h5>
                ...
                <div class="p-2 bg-info-subtle col-3 rounded">
                    <div class="bg-dark text-light rounded p-3 py-5">
                        <h5 class="text-center"><a href="#users" class="text-decoration-none text-light">Current
                                Users</a></h5>
                ...
                <div class="p-2 bg-info-subtle col-3 rounded">
                    <div class="bg-dark text-light rounded p-3 py-5">
                        <h5 class="text-center"><a href="#orders" class="text-decoration-none text-light">Orders</a>
                        </h5>
        ...
        <div class="py-3 vh-100 border-bottom border-light-subtle" id="orders">
            <div class="container py-5 vh-100">
                ...
                <?php require 'php/ordersDisplayTable.php' ?>
            </div>
        </div>
        <!-- order secttion end  -->
        ...
        <div class="py-5 border-bottom border-light-subtle" id="products">
            ...
            <div class="py-2 container" id="laptops">
                ...
                <div class="d-flex justify-content-between mt-3 container">
                    ...
                    <button type="button" class="btn addMoreBtn" data-bs-toggle="modal" data-bs-target="#addLaptop"><i
                            class="fas fa-plus"></i>
                        Add more
                    </button>
                </div>
                ...
                <!-- add laptop Modal -->
                <div class="modal fade" id="addLaptop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                        ...
                        <div class="modal-content" style="background-color: #161b40; color:#fff">
                            ...
                            <div class="modal-body">
                                <form action="addLaptops.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="submit" value="Add" class="btn btn-success text-light mt-3"
                                        style="background-color: #161b40; color#fff; border:1px solid #fff">
                                </form>
                            </div>
                        </div>
                    </div>
            ...
            <div class="py-2 container" id="mobiles">
                ...
                <div class="d-flex justify-content-between mt-3 container">
                    <h4 class="hFont text-light">Current Stock</h4>
                    <button type="button" class="btn addMoreBtn" data-bs-toggle="modal" data-bs-target="#addMobile"><i
                            class="fas fa-plus"></i>
                        Add more
                    </button>
                </div>
                ...
                <!-- add mobiles Modal -->
                <div class="modal fade" id="addMobile" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                    aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content" style="background-color: #161b40; color:#fff">
                            <div class="modal-header">
            ...
            <div class="py-2 container" id="smartWatches">
                ...
                <div class="d-flex justify-content-between mt-3 container">
                    <h4 class="hFont text-light">Current Stock</h4>
                    <button type="button" class="btn addMoreBtn" data-bs-toggle="modal"
                        data-bs-target="#addSmartWatch"><i class="fas fa-plus"></i>
                        Add more
                    </button>
                </div>

                <!-- add smart watch Modal -->
                <div class="modal fade" id="addSmartWatch" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="py-5 vh-100 border-bottom border-light-subtle" id="sales">
            ...
            <?php require 'php/salesDisplayTable.php' ?>
        </div>
