        ...
        .then(data => {
            const detailsHTML = `
                    <div class="cardsContainer p-4" 
                        style="position: relative; max-width: 100%; height: 40rem; overflow-y: auto; background: linear-gradient(to bottom, #e3f2fd, #ffffff); border-radius: 12px; box-shadow: 0 8px 16px rgba(0, 0, 0, 0.2);">
                        <div class="card border-0" 
                            style="width: 100%; height: 100%; display: flex; justify-content: center; align-items: center; border-radius: 12px; padding: 1rem;">
                        
                        <span style="position: absolute; top: 1rem; right: 1rem; font-size: 24px; cursor: pointer; color: #d32f2f; font-weight: bold; transition: transform 0.2s;" 
                        ...
                        <div class="row g-0" 
                            ...
                            <div class="card-body">
                                <h5 class="card-title" 
                                    style="font-size: 2rem; font-weight: bold; color: #1565c0; margin-bottom: 0.5rem;">
                                ${data.brand}
                                </h5>
                                <p class="card-text" 
                                style="font-size: 1.2rem; color: #333; margin-bottom: 1rem;">
                                Price: <strong style="color: #2e7d32;">₹${data.price}</strong>
                                </p>
...
</html><?php require 'php/userSession.php' ?>
